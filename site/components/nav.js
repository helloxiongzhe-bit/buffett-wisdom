...
function isSiteLink(href) {
    ...
    try {
        ...
        return resolved.startsWith('/site/') && resolved.endsWith('.html');
    } catch (e) {
        return false;
    }
}
...
export function createNav(activePage = '') {
    ...
    navPanel.innerHTML = `
        <div class="nav-panel-inner">
            <div class="nav-panel-header">
                <a href="/site/index.html" style="display: flex; align-items: center; gap: 12px; text-decoration: none;">
            ...
            <nav class="nav-panel-links">
                <a href="/site/index.html" class="nav-panel-link ${activePage === 'home' ? 'active' : ''}" data-index="0">
                ...
                <a href="/site/letters.html" class="nav-panel-link ${activePage === 'letters' ? 'active' : ''}" data-index="1">
                ...
                <a href="/site/meetings.html" class="nav-panel-link ${activePage === 'meetings' ? 'active' : ''}" data-index="2">
                ...
                <a href="/site/glossary.html" class="nav-panel-link ${activePage === 'glossary' ? 'active' : ''}" data-index="3">
                ...
                <a href="/site/people.html" class="nav-panel-link ${activePage === 'people' ? 'active' : ''}" data-index="4">
                ...
                <a href="/site/games.html" class="nav-panel-link ${activePage === 'games' ? 'active' : ''}" data-index="5">
    ...
    topBar.innerHTML = `
        <div class="top-bar-inner">
            ...
            <a href="/site/index.html" class="top-bar-logo" style="text-decoration: none;">
    ...
    footer.innerHTML = `
        <div style="max-width: 1280px; margin: 0 auto;">
            <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 24px; margin-bottom: 24px;">
                <a href="/site/index.html" class="nav-link"><i class="ri-home-4-line"></i> ${_isEn ? 'Home' : '首页'}</a>
                <a href="/site/letters.html" class="nav-link"><i class="ri-file-text-line"></i> ${_isEn ? 'Letters' : '股东信'}</a>
                <a href="/site/meetings.html" class="nav-link"><i class="ri-mic-line"></i> ${_isEn ? 'Meetings' : '股东大会'}</a>
                <a href="/site/glossary.html" class="nav-link"><i class="ri-book-2-line"></i> ${_isEn ? 'Glossary' : '名词解释'}</a>
                <a href="/site/people.html" class="nav-link"><i class="ri-user-star-line"></i> ${_isEn ? 'People' : '人物简介'}</a>
                <a href="/site/games.html" class="nav-link"><i class="ri-gamepad-line"></i> ${_isEn ? 'Games' : '休闲游戏'}</a>
            </div>
